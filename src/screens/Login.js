    ...
    return (
        <ScrollView style={{ backgroundColor: "#FFF" }}>
            ...
            <View style={styles.input} >
                ...
                <View style={{ marginTop: 15, width: "100%" }} >
                    {/* <AppButton title="Sign In" onPress={() => loginvalidation()} state={state} /> */}
                    <TouchableOpacity disabled={loading} onPress={() => loginvalidation()} style={{ width: "100%", alignItems: "center", borderRadius: 30, paddingHorizontal: 10, paddingVertical: 15, backgroundColor: Colors.primaryColor }}  >
